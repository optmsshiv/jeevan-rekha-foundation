        ...
        <div class="grid grid-cols-1 md:grid-cols-[0.85fr_1.15fr] gap-14">
            ...
            <div class="space-y-4">
                <details class="glass-card rounded-card p-6 group">
                    ...
                    <p class="font-body text-sm text-on-background/70 mt-4 leading-relaxed">This depends on each person's situation. After assessment, our team will recommend the right duration — <a href="programs" class="text-primary hover:underline">see the full process here</a>.</p>
                </details>
                <details class="glass-card rounded-card p-6 group">
                    <summary class="font-headline text-base text-on-background cursor-pointer list-none flex justify-between items-center gap-4">
